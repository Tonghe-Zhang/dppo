...
class PPODiffusion(VPGDiffusion):
    ...
    def loss(
        ...
        # # print(f"1 oldlogprobs.shape={oldlogprobs.shape}")    # (50,000,4,3)
        ...
        # print(f"2 oldlogprobs.shape={oldlogprobs.shape}")    # (50,000,4,3)
        ...
        # # print(f"discount.shape={discount.shape}, advantages.shape={advantages.shape}")   # 50,00
        advantages *= discount
