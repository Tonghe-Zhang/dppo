...
```
export DPPO_WANDB_ENTITY='tonghezhang01-Tsinghua University'
export DPPO_LOG_DIR=/home/zhangtonghe/dppo/log/gym-pretrain
export DPPO_DATA_DIR=/home/zhangtonghe/dppo/data
```
...
export DPPO_DATA_DIR=<your_prefered_logging_directory>
``` -->
```console
