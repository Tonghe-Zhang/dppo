...
from agent.eval.gold.eval_agent_base import EvalAgent
...
class EvalReFlowAgent(EvalAgent):
    def __init__(self, cfg):
        ...
        self.denoising_steps =[1,2,4,8,16, 20, 64, 128, 256, 512] #[1,2,3,4,5,6,8,10,12,14,16,18,20] #32,64,128,256,512
