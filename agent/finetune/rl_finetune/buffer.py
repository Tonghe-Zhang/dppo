...
def get_buffer(cfg, **args):
    ...
    if cfg.use_ppo:
        return PPOReplayBuffer(cfg.capacity, **args, gamma=cfg.gamma, gae_lambda=cfg.gae_lambda, num_envs=cfg.num_envs)
    
    if cfg.use_replay_parallel_high_dim:
        return ReplayBufferParallelHighdim(cfg.capacity, **args)
...
class ReplayBuffer:
    def __init__(self, capacity:int, state_size, action_size, device, seed):
        self.device = device
...
class ReplayBufferParallelHighdim:
    def __init__(self, capacity:int, num_envs:int, state_size:tuple, action_size:tuple, device, seed):
        self.device = device
