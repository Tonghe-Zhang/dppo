    ...
    def run(self):
        ...
        while self.itr < self.n_train_itr:
            ...
            for step in range(self.n_steps):
                ...
                # Tonghe: only the last step in the denoising process gets rewards. 
            ...
            # Summarize episode reward --- this needs to be 
            # handled differently depending on whether the
            # environment is reset after each iteration. 
            ...
            if not eval_mode:
                ...
                #######################################################################################
                        ''' 
                        Tonghe: 
                        In dppo/model/diffusion/diffusion_vpg.py, the log prob loss is averaged over action horizon and denoising steps. 
                        It might be not reasonable to average denoising steps. 
