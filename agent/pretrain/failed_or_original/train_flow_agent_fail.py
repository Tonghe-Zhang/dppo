...
from model.flow.flow import Flow

class TrainFlowAgent(PreTrainAgent):
    ...
    def run(self):
        ...
        for epoch in range(self.n_epochs):            
            ...
            loss_train, loss_train_var, v_t_magnitude_train, \
            ...
            loss_val, loss_val_var, v_t_magnitude_val, \
    ...
    def statistics(self,loss_epoch,loss_bootstrap_epoch,loss_flow_epoch,v_t_magnitude_epoch,v_prime_magnitude_epoch):
        ...
        return loss, loss_var, v_t_magnitude_, v_t_magnitude_var, v_prime_magnitude_, v_prime_magnitude_var
